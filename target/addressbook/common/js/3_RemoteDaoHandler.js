...
(function(){
	...
	RemoteDaoHandler.prototype.get = function(id) {
		var dfd = $.Deferred();
		var url = this._opts.contextPath + this._opts["get"];
		var params = {
			id: id
		};
	...
	RemoteDaoHandler.prototype.create = function(newEntity) {
		var dfd = $.Deferred();
		var propsStr = newEntity;
		var data = {props:propsStr};
		var url = this._opts.contextPath + this._opts["create"];
	 ...
	 * @param {Object} newEntity if null, does nothing (TODO: needs to throw exception)
	 */
	RemoteDaoHandler.prototype.update = function(props) {
		var dfd = $.Deferred();
		var url = this._opts.contextPath + this._opts["update"];
		var data = {};
		data = {props:props};
		return RemoteDaoHandler.executeAjax(dfd,url,data,true);
	};
	...
	RemoteDaoHandler.prototype["delete"] = function(id) {
		var dfd = $.Deferred();
		var params = {id:id};
		var url = this._opts.contextPath + this._opts["delete"] ;
